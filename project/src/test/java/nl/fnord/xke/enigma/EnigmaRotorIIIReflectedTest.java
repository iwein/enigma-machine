...
public class EnigmaRotorIIIReflectedTest extends EnigmaRotorTest {

    public EnigmaRotorIIIReflectedTest(int input, int expectedIndex) {
        super(input, expectedIndex);
    }

    @Override
    int transform(int param, Enigma enigma) {
        return enigma.rotor3reflected(param);
    }

    @Parameters
    public static List<Object[]> data() {
        return dataNotched(realAlphabet, alphabetIII);
    }
}
